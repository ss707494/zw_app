...
// language=GraphQL
String getGroupOrderListDoc = r'''query {
     group_order_list {
        id
        name
        create_time
...
// language=GraphQL
String saveGroupOrderDoc = r'''
mutation ($saveGroupOrderInput: SaveGroupOrderInput, $saveOrderInput: SaveOrderInput) {
    save_group_order(saveGroupOrderInput: $saveGroupOrderInput, saveOrderInput: $saveOrderInput) {
      flag
      msg
      order {
        id
