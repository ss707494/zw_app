...
class GroupOrderHistory extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    OrderModel orderHistoryModel = Provider.of<OrderModel>(context);
    List<OrderItemEntity> groupOrderList = orderHistoryModel.groupOrderList;
    ...
    return Scaffold(
      ...
      body: EasyRefresh(
        ...
        onRefresh: () async {
          await orderHistoryModel.getGroupData(context);
        },
        child: ListView.builder(
          itemCount: groupOrderList.length,
          itemBuilder: (context, index) {
            OrderItemEntity orderItem = groupOrderList[index];
            return Column(
              children: <Widget>[
