...
class NestedScrollView extends StatefulWidget {
  ...
  final Function refreshWidgetBuild;
  ...
  const NestedScrollView({
    ...
    @required this.body,
    this.dragStartBehavior = DragStartBehavior.start, this.refreshWidgetBuild,
    ...
    return _InheritedNestedScrollView(
      ...
      child: Builder(
        builder: (BuildContext context) {
          ...
          return widget.refreshWidgetBuild != null ? widget.refreshWidgetBuild(
            child: _NestedScrollViewCustomScrollView(
