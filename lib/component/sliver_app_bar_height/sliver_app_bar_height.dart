...
class SliverAppBarHeight extends StatefulWidget {
  ...
  const SliverAppBarHeight({
    ...
    this.snap = false,
    this.shape,
    this.customizeHeight = kToolbarHeight,
...
class _SliverAppBarState extends State<SliverAppBarHeight> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SliverAppBarHeight oldWidget) {
    ...
    return MediaQuery.removePadding(
      ...
      child: SliverPersistentHeader(
        ...
        delegate: _SliverAppBarDelegate(
          ...
          customizeHeight: widget.customizeHeight,
        ),
      ),
    );
  }
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    final double toolbarOpacity = !pinned || (floating && bottom != null)
        ? ((visibleMainHeight - _bottomHeight) / customizeHeight).clamp(0.0, 1.0)
        : 1.0;
