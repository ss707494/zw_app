...
final GraphQLClient graphQLClient = GraphQLClient(
    ...
    link: AuthLink(getToken: () async {
      return (await getStorageByKey('token') ?? '');
        ...
        .concat(HttpLink(uri: '${serverHost}type__graphql/api')));

Future<QueryResult> graphqlQueryByType__Graphql(context, document, {data = const <String, dynamic>{}, fetchPolicy = FetchPolicy.cacheAndNetwork}) async {
